...
#'    \item{link}{URL linking to revelant context, source information or large version of comic}
...
#'    \item{safe_title}{We still don't now what this is safe for, Embedding maybe?}
